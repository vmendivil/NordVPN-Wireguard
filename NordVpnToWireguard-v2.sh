...
# Create new filename with format: yyyymmdd-Country-City-Endpoint.conf
OUTPUTFILENAME="Connections/${CURRENT_DATE}-${COUNTRY_CLEAN}-${CITY_CLEAN}-${ENDPOINT_SHORT}.conf"
